...
export async function generateReceiptPDF({
    ...
    let html = `
        <html>
            <head>
                <style>
                    @page { ${receiptPaperSize === 'a4' ? 'size: A4 portrait; margin: 10mm;' : 'margin: 0; size: 80mm auto;'} }
                    body {
                        font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;
                        font-size: ${receiptPaperSize === 'a4' ? '14px' : '11px'};
                        margin: 0;
                        padding: ${receiptPaperSize === 'a4' ? '20px' : '10px'};
                        width: ${receiptPaperSize === 'a4' ? '100%' : '76mm'};
                        color: #000;
                    }
