...
export default function HomeworkScreen() {
    ...
    const { data: homeworkData, isLoading } = useQuery({
        queryKey: ['homework', schoolId, userId],
        queryFn: async () => {
            if (!schoolId || !userId) return { homework: [], total: 0 };

            const res = await api.get(`/schools/homework?schoolId=${schoolId}&studentId=${userId}`);
            return res.data;
        },
        ...
        <View style={styles.container}>
            ...
            <Animated.View entering={FadeInDown.duration(400)} style={styles.header}>
                ...
                <View style={styles.headerCenter}>
                    ...
                    <Text style={styles.headerSubtitle}>Your assignments</Text>
                </View>
